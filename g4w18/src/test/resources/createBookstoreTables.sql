...
"Amos Daragon's life changes forever the day a mermaid gives him a mask capable of harnessing the strength of the windÃ¢â‚¬â€�and appoints Amos as the new Mask Wearer. His task: to find the masks for the other elements, earth, fire, and water. Only then will Amos be fully empowered to battle the evil forces that threaten to destroy the balance of nature and plunge the world into darkness.To fulfill his destiny, Amos must make his way to the mysterious woods of Tarkasis. But a wicked sorcerer is terrorizing the land, searching for a skull pendant that was stolen from himÃ¢â‚¬â€�a pendant that conceals a secret weapon. What will Amos do when the pendant falls into his hands? Will Beorf, a boy who can morph into a bear, and Medusa, a snake-haired gorgon, turn out to be friend or foe? And will Amos master any of his newfound skills as Mask Wearer in time to face a formidable enemy? His chanllenges are great . . .  and they're just beginning.",
...
While on routine patrol in the tinder-dry Topanga Canyon, environmental scientist Rafael Salazar expects to find animal poachers, not a dilapidated antique steamer trunk. Inside the peculiar case, he discovers a journal, written by the renowned Robert Louis Stevenson, which divulges ominous particulars about his creation of The Strange Case of Dr. Jekyll and Mr. Hyde. It also promises to reveal a terrible secretÃ¢â‚¬â€�the identity of Jack the Ripper.
Unfortunately, the journalÃ¢â‚¬â€�whose macabre tale unfolds in an alternating narrative with RafeÃ¢â‚¬â„¢sÃ¢â‚¬â€�isnÃ¢â‚¬â„¢t the only relic in the trunk, and Rafe isnÃ¢â‚¬â„¢t the only one to purloin a souvenir. A mysterious flask containing the last drops of the grisly potion that inspired Jekyll and Hyde and spawned LondonÃ¢â‚¬â„¢s most infamous killer has gone missing. And it has definitely fallen into the wrong hands.",
...
The sickness came on suddenly, and spread quickly. The fear spread even faster. Within weeks, everything people counted on began to fail them. The electrical grid sputtered; law and government collapsedÃ¢â‚¬â€�and more than half of the worldÃ¢â‚¬â„¢s population was decimated.

Where there had been order, there was now chaos. And as the power of science and technology receded, magick rose up in its place. Some of it is good, like the witchcraft worked by Lana Bingham, practicing in the loft apartment she shares with her lover, Max. Some of it is unimaginably evil, and it can lurk anywhere, around a corner, in fetid tunnels beneath the riverÃ¢â‚¬â€�or in the ones you know and love the most.
...
"Who poisoned the wealthy Emily Inglethorp and how did the murderer penetrate and escape from her locked bedroom? Suspects abound in the quaint village of Styles St. MaryÃ¢â‚¬â€�from the heiress's fawning new husband to her two stepsons, her volatile housekeeper, and a pretty nurse who works in a hospital dispensary.
...
A year later, Anna is still missing. Ella is wracked with guilt over what she failed to do, and sheÃ¢â‚¬â„¢s not the only one who canÃ¢â‚¬â„¢t forget. Someone is sending her threatening lettersÃ¢â‚¬â€�letters that make her fear for her life.

Then an anniversary appeal reveals that AnnaÃ¢â‚¬â„¢s friends and family might have something to hide. AnnaÃ¢â‚¬â„¢s best friend, Sarah, hasnÃ¢â‚¬â„¢t been telling the whole truth about what really happened that nightÃ¢â‚¬â€�and her parents have been keeping secrets of their own.

Someone knows where Anna isÃ¢â‚¬â€�and theyÃ¢â‚¬â„¢re not telling. But they are watching Ella.",
...
"The year is 1896. The city is New York. Newspaper reporter John Schuyler Moore is summoned by his friend Dr. Laszlo KreizlerÃ¢â‚¬â€�a psychologist, or Ã¢â‚¬Å“alienistÃ¯Â¿Â½?Ã¢â‚¬â€�to view the horribly mutilated body of an adolescent boy abandoned on the unfinished Williamsburg Bridge. From there the two embark on a revolutionary effort in criminology: creating a psychological profile of the perpetrator based on the details of his crimes. Their dangerous quest takes them into the tortured past and twisted mind of a murderer who will kill again before their hunt is over.",
...
"An ancient secret brotherhood. A devastating new weapon of destruction. An unthinkable target. When world-renowned Harvard symbologist Robert Langdon is summoned to his first assignment to a Swiss research facility to analyze a mysterious symbolÃ¢â‚¬â€�seared into the chest of a murdered physicistÃ¢â‚¬â€�he discovers evidence of the unimaginable: the resurgence of an ancient secret brotherhood known as the Illuminati...the most powerful underground organization ever to walk the earth. The Illuminati has now surfaced to carry out the final phase of its legendary vendetta against its most hated enemyÃ¢â‚¬â€�the Catholic Church.
...
"One of the most famous and beloved mysteries from The Queen of SuspenseÃ¢â‚¬â€�Agatha ChristieÃ¢â‚¬â€�now a Lifetime TV movie.
...
So when a chance at a huge score finally comes her way, Jazz canÃ¢â‚¬â„¢t say no. Sure, it requires her to graduate from small-time smuggler to full-on criminal mastermind. And it calls for a particular combination of cunning, technical skills, and large explosionsÃ¢â‚¬â€�not to mention sheer brazen swagger. But Jazz has never run into a challenge her intellect canÃ¢â‚¬â„¢t handle, and she figures sheÃ¢â‚¬â„¢s got the Ã¢â‚¬ËœswaggerÃ¢â‚¬â„¢ part down. 
...
Bren's job is as general peacemakerÃ¢â‚¬â€�but old enemies want war. Is Bren's diplomatic acumen enough to prevent a war that both sides are prepared to wage?",
...
"Stories of Your Life and Others delivers dual delights of the very, very strange and the heartbreakingly familiar, often presenting characters who must confront sudden changeÃ¢â‚¬â€�the inevitable rise of automatons or the appearance of aliensÃ¢â‚¬â€�with some sense of normalcy. With sharp intelligence and humor, Chiang examines what it means to be alive in a world marked by uncertainty, but also by beauty and wonder. An award-winning collection from one of today's most lauded writers, Stories of Your Life and Others is a contemporary classic.",
...
We met at a weddingÃ¢â‚¬â€�him sitting on the groomÃ¢â‚¬â„¢s side, me sitting on the brideÃ¢â‚¬â„¢s. Stealing glances at each other throughout the night, there was no denying an intense, mutual attraction.
...
"Sybil and Blake Gregory have established a predictable, well-ordered Manhattan lifeÃ¢â‚¬â€�she as a cutting-edge design authority and museum consultant, he in high-tech investmentsÃ¢â‚¬â€�raising their teenagers Andrew and Caroline and six-year-old Charlie. But everything changes when Blake is offered a dream job he canÃ¢â‚¬â„¢t resist as CEO of a start-up in San Francisco. He accepts it without consulting his wife and buys a magnificent, irresistibly underpriced historic Pacific Heights mansion as their new home.
...
All long since dead. All very much alive in spiritÃ¢â‚¬â€�and visible to the Gregorys and no one else. The two families are delighted to share elegant dinners and warm friendship. They have much to teach each other, as the Gregorys watch the past unfold while living their own modern-day lives. Within these enchanted rooms, it is at once 1917 and a century later, where the Gregorys gratefully realize they have been given a perfect giftÃ¢â‚¬â€�beloved friends and the wisdom to shape their own future with grace from a fascinating past.", 
...
"Pro footballer Miller Quinton would do anything for his best friend and teammateÃ¢â‚¬â€�including Ã¢â‚¬Å“fake datingÃ¯Â¿Â½? his friendÃ¢â‚¬â„¢s sister. What no one knows is that seven months ago in Vegas, Miller and Kinsey did a whole lot more than just kiss. Miller knows that this cheerleader is off-limits to him and any guy on the team. Still, he canÃ¢â‚¬â„¢t stop himself.

KinseyÃ¢â‚¬â„¢s whole world is on the verge of crumbling. Her dad has cancer. Her overprotective brother is falling apart. Dating Miller may be a fake-out, but heÃ¢â‚¬â„¢s the one guy who can make her forget about everythingÃ¢â‚¬â€�including all the reasons she stayed away from football players. With each heated moment, Miller feels more like a safe placeÃ¢â‚¬Â¦even though heÃ¢â‚¬â„¢s not safe at all.
...
"In this commanding book, Pulitzer PrizeÃ¢â‚¬â€œwinning author Robert K. Massie sweeps readers back to the extraordinary world of Imperial Russia to tell the story of the RomanovsÃ¢â‚¬â„¢ lives: NicholasÃ¢â‚¬â„¢s political naÃƒÂ¯vetÃƒÂ©, AlexandraÃ¢â‚¬â„¢s obsession with the corrupt mystic Rasputin, and little AlexisÃ¢â‚¬â„¢s brave struggle with hemophilia. Against a lavish backdrop of luxury and intrigue, Massie unfolds a powerful drama of passion and historyÃ¢â‚¬â€�the story of a doomed empire and the death-marked royals who watched it crumble.",
...
In this memoir translated from the original Japanese, Ishikawa candidly recounts his tumultuous upbringing and the brutal thirty-six years he spent living under a crushing totalitarian regime, as well as the challenges he faced repatriating to Japan after barely escaping North Korea with his life. A River in Darkness is not only a shocking portrait of life inside the country but a testament to the dignityÃ¢â‚¬â€�and indomitable natureÃ¢â‚¬â€�of the human spirit.",
...
"Against the monumental canvas of seventeenth- and eighteenth-century Europe and Russia unfolds the magnificent story of Peter the Great, crowned co-tsar at the age of ten. Robert K. Massie delves deep into the life of this captivating historical figure, chronicling the pivotal events that shaped a boy into a legendÃ¢â‚¬â€�including his Ã¢â‚¬Å“incognitoÃ¯Â¿Â½? travels in Europe, his unquenchable curiosity about Western ways, his obsession with the sea and establishment of the stupendous Russian navy, his creation of an unbeatable army, his transformation of Russia, and his relationships with those he loved most: Catherine, the robust yet gentle peasant, his loving mistress, wife, and successor; and Menshikov, the charming, bold, unscrupulous prince who rose to wealth and power through PeterÃ¢â‚¬â„¢s friendship. Impetuous and stubborn, generous and cruel, tender and unforgiving, a man of enormous energy and complexity, Peter the Great is brought fully to life.",

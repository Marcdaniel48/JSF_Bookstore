...
public class JPAReviewTest
{
     ...
     * @author Jephthia
     */
    public void testFindApprovedReviews()
    {
        List<Review> reviews = reviewController.getApprovedReviews();
        
        List<Integer> actualIDs = new ArrayList<Integer>();
        
        for(Review r : reviews)
            actualIDs.add(r.getReviewId());
     ...
     * @author Jephthia
     */
    public void testFindNotApprovedReviews()
    {
        List<Review> reviews = reviewController.getNotApprovedReviews();
